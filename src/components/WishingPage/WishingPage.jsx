...
import songFile from  "../../../public/Photos/song2.mpeg?url"
...
I'm really glad you exist 🌷`;
  ...
  return (
    ...
    >
      ...
      >
        <motion.div
          className="relative w-72 h-80 rounded-3xl overflow-hidden shadow-2xl border-4 border-white cursor-pointer hover:shadow-[0_20px_60px_rgba(255,192,203,0.6)] transition-all duration-500"
